    ...
    function cargarTrabajador(){
        ...
        $.ajax({
            ...
            $.each(listaTrabajador, function(key, value){
                ...
                $("#tableTrabajdor").find("tbody").append(
                        "<tr>"+
                           "<td>"+value.nombres+"</td>"+
         ...
         $("tableTrabajdor").find("tbody").show("slow")
        });
    }
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
             ...
             <button class="btn btn-primary" onclick="cargarTrabajador()">Refrescar</button> 
          <div class="widget-content nopadding" >
             
            <table class="table table-bordered data-table" id="tableTrabajdor" >
              <thead>
                <tr>
