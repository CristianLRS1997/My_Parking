...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Mensualidad</a> <a href="#" class="current">Registro</a> </div>
    <h1>Registro Mensualidad</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="Mensualidad/create" id="Trabajador" >
              <div class="control-group">
                <label class="control-label">Fecha Inico</label>
                <div class="controls">
                ...
                <div class="controls">
                 ...
                 <label class="control-label">Puesto</label>
                  <div class="controls">
                      <input type="text" name="puesto"  readonly required />
                  </div>
                </div>
                   <div class="control-group">
...
<script src="js/validateTrabajador.js"></script> 
